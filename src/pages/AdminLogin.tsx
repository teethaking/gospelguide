...
const AdminLogin: React.FC<AdminLoginProps> = ({ isAuthenticated, setIsAuthenticated }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (credentials.username === 'admin' && credentials.password === 'samarthur2024') {
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sam Arthur Signs & Fabrication - Admin Dashboard
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-orange-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-orange-700 transition-colors focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">
              Demo credentials: admin / samarthur2024
            </p>
          </div>
        </div>
      </div>
